            ...
            <ScrollAnimation direction="right" delay={0.1}>
              <div className="text-center md:text-left">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  You created an amazing product, but marketing feels
                  overwhelming. We make it simple—just describe what you need in
                  plain language.
                </p>
              </div>
            </ScrollAnimation>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Real outcomes that help you grow your business and reach more
              customers
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Get Customers Fast",
                description:
                  "Start getting real customers within days, not months. Skip the marketing learning curve and launch with confidence.",
              },
              {
                icon: "M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z",
                title: "No Marketing Jargon",
                description:
                  "Plain language guidance that makes sense. No buzzwords or confusing terms—just clear, actionable help.",
              },
              {
                icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
                title: "No Experience Needed",
                description:
                  "You don't need a marketing degree. Just describe your product naturally, and we'll handle the strategy.",
              },
              {
                icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z",
                title: "Save Time & Money",
                description:
                  "Create professional content in minutes instead of spending hours or thousands on agencies.",
              },
              {
                icon: "M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12",
                title: "Reach More Customers",
                description:
                  "Create optimized content for Instagram, Twitter, Facebook, and more—all from one platform.",
              },
              {
                icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
                title: "Track What Matters",
                description:
                  "Monitor performance in real-time and automatically scale what's working best.",
              },
            ].map((item, idx) => (
      ...
      <section className="container mx-auto px-4 py-20 relative bg-gradient-to-br from-muted/40 via-muted/30 to-muted/30 rounded-3xl my-8 border-2 border-border shadow-lg overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Perfect for entrepreneurs, small businesses, and creators
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Launch products quickly and reach your target audience without the marketing complexity.",
              },
              {
                icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
                title: "Small Business Owners",
                description:
                  "Expand your online presence and compete with larger brands on a level playing field.",
              },
              {
                icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",
                title: "Creators & Content Makers",
                description:
                  "Promote your creative work, build an audience, and grow your brand effortlessly.",
              },
            ].map((item, idx) => (
              <ScrollAnimation key={idx} direction="up" delay={idx * 0.1}>
                <Card
              ...
              <Card className="relative bg-gradient-to-br from-muted/30 via-muted/20 to-muted/30 border-border/50 shadow-2xl">
                <CardContent className="py-16 px-8">
                  ...
                  <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                    Join creators who&apos;ve transformed their marketing.
                    Create social media content with natural language—no
